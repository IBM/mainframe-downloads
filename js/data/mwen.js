...
IBMCore.common.util.data.provide('v18main', {
  ...
  mastheadNav: {
    links: [
        ...
        menuSections: [
          {
            ...
            menuItems: [
              {
                title: 'All products',
                url: 'https://www.ibm.com/products?lnk=mpra_mwen&lnk2=learn',
              },
            ],
          },
          {
            ...
            menuItems: [
              {
                title: 'Products',
                url: 'https://www.ibm.com/products?lnk=mpr_mwen&lnk2=learn',
              },
              {
                title: 'Analytics',
                url:
                  'https://www.ibm.com/analytics?lnk=mpr_bua_mwen&lnk2=learn',
              },
              {
                title: 'Automation',
                url:
                  'https://www.ibm.com/automation?lnk=mpr_buau_mwen&lnk2=learn',
              },
              {
                title: 'Blockchain',
                url:
                  'https://www.ibm.com/blockchain?lnk=mpr_bubk_mwen&lnk2=learn',
              },
              {
                title: 'Cloud',
                url: 'https://www.ibm.com/cloud?lnk=mpr_bucl_mwen&lnk2=learn',
              },
              {
                title: 'Internet of Things',
                url:
                  'https://www.ibm.com/internet-of-things?lnk=mpr_iot_mwen&lnk2=learn',
              },
              {
                title: 'IT Infrastructure',
                url:
                  'https://www.ibm.com/it-infrastructure?lnk=mpr_buit_mwen&lnk2=learn',
              },
              {
                title: 'Mobile',
                url: 'https://www.ibm.com/mobile?lnk=mpr_bumf_mwen&lnk2=learn',
              },
              {
                title: 'Security',
                url:
                  'https://www.ibm.com/security?lnk=mpr_buse_mwen&lnk2=learn',
              },
              {
                title: 'Supply Chain',
                url:
                  'https://www.ibm.com/supply-chain?lnk=mpr_busc_mwen&lnk2=learn',
              },
              {
                title: 'Talent',
                url:
                  'https://www.ibm.com/services/process/talent?lnk=mpr_buta_mwen&lnk2=learn',
              },
              {
                title: 'Watson',
                url: 'https://www.ibm.com/watson?lnk=mpr_buwa_mwen&lnk2=learn',
              },
              {
                title: 'Watson Health',
                url:
                  'https://www.ibm.com/watson/health?lnk=mpr_buwh_mwen&Ink2=learn',
              },
            ],
          },
        ],
            ...
            menuItems: [
              {
                title: 'Financing (US)',
                url:
                  'https://www.ibm.com/financing?lnk=mse_fin_mwen&lnk2=learn',
              },
              {
                title: 'Industry expertise (US)',
                url:
                  'https://www.ibm.com/industries?lnk=mse_ie_mwen&lnk2=learn',
              },
              {
                title: 'Training and skills (US)',
                url: 'https://www.ibm.com/training?lnk=mse_tr_mwen&lnk2=learn',
              },
            ],
          },
        ],
      ...
      {
        title: 'Industries',
        url: 'https://www.ibm.com/industries?lnk=min_mwen',
        hasMenu: false,
        hasMegapanel: false,
        menuSections: [],
      },
  ...
  footerMenu: [
    {
      ...
      links: [
        {
          title: 'Products (US)',
          url: 'https://www.ibm.com/products?lnk=fdi_mwen',
        },
        {
          title: 'Redbooks (US)',
          url: 'https://www.redbooks.ibm.com?lnk=fdi_mwen',
        },
        {
          title: 'Services (US)',
          url: 'https://www.ibm.com/services?lnk=fdi_mwen',
        },
        {
          title: 'Industries (US)',
          url: 'https://www.ibm.com/industries?lnk=fdi_mwen',
        },
        {
          title: 'IBM Research (US)',
          url: 'https://research.ibm.com?lnk=fdi_mwen',
        },
        {
          title: 'Case studies (US)',
          url: 'https://www.ibm.com/case-studies?lnk=fdi_mwen',
        },
        {
          title: 'Financing (US)',
          url: 'https://www.ibm.com/financing?ref=ibmfooter&lnk=fdi_mwen',
        },
      ],
    },
    {
      ...
      links: [
        {
          title: 'Developers (US)',
          url: 'https://www.ibm.com/developerworks?lnk=fif_mwen',
        },
        {
          title: 'Business Partners',
          url: 'https://www.ibm.com/partnerworld?lnk=fif_mwen',
        },
      ],
    },
    {
      ...
      links: [
        { title: 'Support', url: 'https://www.ibm.com/support/mw/en/' },
        {
    ...
    },
    {
      ...
      links: [
        ...
        { title: 'About IBM', url: 'https://www.ibm.com/mw-en/about' },
      ],
    },
  ],
  footerThin: [
    { title: 'Contact', url: 'https://www.ibm.com/contact/mw/en/' },
    { title: 'Privacy', url: 'https://www.ibm.com/privacy/mw/en/' },
    { title: 'Terms of use', url: 'https://www.ibm.com/mw-en/legal' },
    { title: 'Accessibility', url: 'https://www.ibm.com/accessibility/mw/en/' },
  ],
  localeSelector: {
