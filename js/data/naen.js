...
IBMCore.common.util.data.provide('v18main', {
  ...
  mastheadNav: {
    links: [
        ...
        menuSections: [
          {
            ...
            menuItems: [
              {
                title: 'All products',
                url: 'https://www.ibm.com/products?lnk=mpra_naen&lnk2=learn',
              },
            ],
          },
          {
            ...
            menuItems: [
              {
                title: 'Products',
                url: 'https://www.ibm.com/products?lnk=mpr_naen&lnk2=learn',
              },
              {
                title: 'Analytics',
                url:
                  'https://www.ibm.com/analytics?lnk=mpr_bua_naen&lnk2=learn',
              },
              {
                title: 'Automation',
                url:
                  'https://www.ibm.com/automation?lnk=mpr_buau_naen&lnk2=learn',
              },
              {
                title: 'Blockchain',
                url:
                  'https://www.ibm.com/blockchain?lnk=mpr_bubk_naen&lnk2=learn',
              },
              {
                title: 'Cloud',
                url: 'https://www.ibm.com/cloud?lnk=mpr_bucl_naen&lnk2=learn',
              },
              {
                title: 'Internet of Things',
                url:
                  'https://www.ibm.com/internet-of-things?lnk=mpr_iot_naen&lnk2=learn',
              },
              {
                title: 'IT Infrastructure',
                url:
                  'https://www.ibm.com/it-infrastructure?lnk=mpr_buit_naen&lnk2=learn',
              },
              {
                title: 'Mobile',
                url: 'https://www.ibm.com/mobile?lnk=mpr_bumf_naen&lnk2=learn',
              },
              {
                title: 'Security',
                url:
                  'https://www.ibm.com/security?lnk=mpr_buse_naen&lnk2=learn',
              },
              {
                title: 'Supply Chain',
                url:
                  'https://www.ibm.com/supply-chain?lnk=mpr_busc_naen&lnk2=learn',
              },
              {
                title: 'Talent',
                url:
                  'https://www.ibm.com/services/process/talent?lnk=mpr_buta_naen&lnk2=learn',
              },
              {
                title: 'Watson',
                url: 'https://www.ibm.com/watson?lnk=mpr_buwa_naen&lnk2=learn',
              },
              {
                title: 'Watson Health',
                url:
                  'https://www.ibm.com/watson/health?lnk=mpr_buwh_naen&Ink2=learn',
              },
            ],
          },
        ],
            ...
            menuItems: [
              {
                title: 'Financing (US)',
                url:
                  'https://www.ibm.com/financing?lnk=mse_fin_naen&lnk2=learn',
              },
              {
                title: 'Industry expertise (US)',
                url:
                  'https://www.ibm.com/industries?lnk=mse_ie_naen&lnk2=learn',
              },
              {
                title: 'Training and skills (US)',
                url: 'https://www.ibm.com/training?lnk=mse_tr_naen&lnk2=learn',
              },
            ],
          },
        ],
      ...
      {
        title: 'Industries',
        url: 'https://www.ibm.com/industries?lnk=min_naen',
        hasMenu: false,
        hasMegapanel: false,
        menuSections: [],
      },
  ...
  footerMenu: [
    {
      ...
      links: [
        {
          title: 'Products (US)',
          url: 'https://www.ibm.com/products?lnk=fdi_naen',
        },
        {
          title: 'Redbooks (US)',
          url: 'https://www.redbooks.ibm.com?lnk=fdi_naen',
        },
        {
          title: 'Services (US)',
          url: 'https://www.ibm.com/services?lnk=fdi_naen',
        },
        {
          title: 'Industries (US)',
          url: 'https://www.ibm.com/industries?lnk=fdi_naen',
        },
        {
          title: 'IBM Research (US)',
          url: 'https://research.ibm.com?lnk=fdi_naen',
        },
        {
          title: 'Case studies (US)',
          url: 'https://www.ibm.com/case-studies?lnk=fdi_naen',
        },
        {
          title: 'Financing (US)',
          url: 'https://www.ibm.com/financing?ref=ibmfooter&lnk=fdi_naen',
        },
      ],
    },
    {
      ...
      links: [
        {
          title: 'Developers (US)',
          url: 'https://www.ibm.com/developerworks?lnk=fif_naen',
        },
        {
          title: 'Business Partners',
          url: 'https://www.ibm.com/partnerworld?lnk=fif_naen',
        },
      ],
    },
    {
      ...
      links: [
        { title: 'Support', url: 'https://www.ibm.com/support/na/en/' },
        {
    ...
    },
    {
      ...
      links: [
        ...
        { title: 'About IBM', url: 'https://www.ibm.com/na-en/about' },
      ],
    },
  ],
  footerThin: [
    { title: 'Contact', url: 'https://www.ibm.com/contact/na/en/' },
    { title: 'Privacy', url: 'https://www.ibm.com/privacy/na/en/' },
    { title: 'Terms of use', url: 'https://www.ibm.com/na-en/legal' },
    { title: 'Accessibility', url: 'https://www.ibm.com/accessibility/na/en/' },
  ],
  localeSelector: {
