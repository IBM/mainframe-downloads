...
IBMCore.common.util.data.provide('v18main', {
  ...
  mastheadNav: {
    links: [
        ...
        menuSections: [
          {
            ...
            menuItems: [
              {
                title: 'All products',
                url: 'https://www.ibm.com/products?lnk=mpra_ugen&lnk2=learn',
              },
            ],
          },
          {
            ...
            menuItems: [
              {
                title: 'Products',
                url: 'https://www.ibm.com/products?lnk=mpr_ugen&lnk2=learn',
              },
              {
                title: 'Analytics',
                url:
                  'https://www.ibm.com/analytics?lnk=mpr_bua_ugen&lnk2=learn',
              },
              {
                title: 'Automation',
                url:
                  'https://www.ibm.com/automation?lnk=mpr_buau_ugen&lnk2=learn',
              },
              {
                title: 'Blockchain',
                url:
                  'https://www.ibm.com/blockchain?lnk=mpr_bubk_ugen&lnk2=learn',
              },
              {
                title: 'Cloud',
                url: 'https://www.ibm.com/cloud?lnk=mpr_bucl_ugen&lnk2=learn',
              },
              {
                title: 'Internet of Things',
                url:
                  'https://www.ibm.com/internet-of-things?lnk=mpr_iot_ugen&lnk2=learn',
              },
              {
                title: 'IT Infrastructure',
                url:
                  'https://www.ibm.com/it-infrastructure?lnk=mpr_buit_ugen&lnk2=learn',
              },
              {
                title: 'Mobile',
                url: 'https://www.ibm.com/mobile?lnk=mpr_bumf_ugen&lnk2=learn',
              },
              {
                title: 'Security',
                url:
                  'https://www.ibm.com/security?lnk=mpr_buse_ugen&lnk2=learn',
              },
              {
                title: 'Supply Chain',
                url:
                  'https://www.ibm.com/supply-chain?lnk=mpr_busc_ugen&lnk2=learn',
              },
              {
                title: 'Talent',
                url:
                  'https://www.ibm.com/services/process/talent?lnk=mpr_buta_ugen&lnk2=learn',
              },
              {
                title: 'Watson',
                url: 'https://www.ibm.com/watson?lnk=mpr_buwa_ugen&lnk2=learn',
              },
              {
                title: 'Watson Health',
                url:
                  'https://www.ibm.com/watson/health?lnk=mpr_buwh_ugen&Ink2=learn',
              },
            ],
          },
        ],
            ...
            menuItems: [
              {
                title: 'Financing (US)',
                url:
                  'https://www.ibm.com/financing?lnk=mse_fin_ugen&lnk2=learn',
              },
              {
                title: 'Industry expertise (US)',
                url:
                  'https://www.ibm.com/industries?lnk=mse_ie_ugen&lnk2=learn',
              },
              {
                title: 'Training and skills (US)',
                url: 'https://www.ibm.com/training?lnk=mse_tr_ugen&lnk2=learn',
              },
            ],
          },
        ],
      ...
      {
        title: 'Industries',
        url: 'https://www.ibm.com/industries?lnk=min_ugen',
        hasMenu: false,
        hasMegapanel: false,
        menuSections: [],
      },
  ...
  footerMenu: [
    {
      ...
      links: [
        {
          title: 'Products (US)',
          url: 'https://www.ibm.com/products?lnk=fdi_ugen',
        },
        {
          title: 'Redbooks (US)',
          url: 'https://www.redbooks.ibm.com?lnk=fdi_ugen',
        },
        {
          title: 'Services (US)',
          url: 'https://www.ibm.com/services?lnk=fdi_ugen',
        },
        {
          title: 'Industries (US)',
          url: 'https://www.ibm.com/industries?lnk=fdi_ugen',
        },
        {
          title: 'IBM Research (US)',
          url: 'https://research.ibm.com?lnk=fdi_ugen',
        },
        {
          title: 'Case studies (US)',
          url: 'https://www.ibm.com/case-studies?lnk=fdi_ugen',
        },
        {
          title: 'Financing (US)',
          url: 'https://www.ibm.com/financing?ref=ibmfooter&lnk=fdi_ugen',
        },
      ],
    },
    {
      ...
      links: [
        {
          title: 'Developers (US)',
          url: 'https://www.ibm.com/developerworks?lnk=fif_ugen',
        },
        {
          title: 'Business Partners',
          url: 'https://www.ibm.com/partnerworld?lnk=fif_ugen',
        },
      ],
    },
    {
      ...
      links: [
        { title: 'Support', url: 'https://www.ibm.com/support/ug/en/' },
        {
    ...
    },
    {
      ...
      links: [
        ...
        { title: 'About IBM', url: 'https://www.ibm.com/ug-en/about' },
      ],
    },
  ],
  footerThin: [
    { title: 'Contact', url: 'https://www.ibm.com/contact/ug/en/' },
    { title: 'Privacy', url: 'https://www.ibm.com/privacy/ug/en/' },
    { title: 'Terms of use', url: 'https://www.ibm.com/ug-en/legal' },
    { title: 'Accessibility', url: 'https://www.ibm.com/accessibility/ug/en/' },
  ],
  localeSelector: {
