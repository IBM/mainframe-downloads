function toggleCourseTabs(whichTab){
    ...
    var table4 = document.getElementById("course-calendar-table4")
    var button4 = document.getElementById("courses-tab4")
//002d9c selected
//4589ff unselected
    switch(whichTab){
        case 1:
            ...
            table4.setAttribute("style", "width:100%; display:none;")
            button4.setAttribute("style", "background: #4589ff; border-color: #4589ff;");
            break;
        case 2:
        ...
        case 4:
            ...
            table3.setAttribute("style", "width:100%; display:none;")
            button3.setAttribute("style", "background: #4589ff; border-color: #4589ff;");          
            table4.setAttribute("style", "width:100%;")
            button4.setAttribute("style", "background: #002d9c; border-color: #002d9c;");  
            break;
        default:
    }
}